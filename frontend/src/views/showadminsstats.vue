...
export default {
  ...
  data() {
    return {
      token: null,
      pieChartImage: "", // Store the URL for the pie chart
    };
  },
      ...
      axios
        ...
        .then((response) => {
          if (response.status === 200) {
            ...
            this.pieChartImage = "http://localhost:5002/api/showstats"; // Dynamically load pie chart
          }
        })
        .catch((error) => {
