<template>
    <nav class="navbar">
      <div class="navbar-links">
        <h4 style="font-family: Georgia, 'Times New Roman', Times, serif;">Customer Dashboard</h4>
        <router-link to="/customerdashboard" class="nav-link" active-class="active">Home</router-link> |
        <router-link to="/customersearch" class="nav-link" active-class="active">Search</router-link> |
  ...
  .navbar {
    background-color:  #b0cf19; /* Blue background */
    padding: 10px 20px;
    color: white;
    display: flex;
  ...
  .nav-link.active {
    background-color: #f39c12; /* Yellow for the active link */
    color: white;
  }
